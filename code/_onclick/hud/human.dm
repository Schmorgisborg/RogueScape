...
/datum/hud/spirit/New(mob/living/carbon/spirit/owner)
	..()
	...
	backhudl =  new /obj/screen/backhudl/obs()
	backhudl.hud = src
	backhudl.icon_state = "spirit"
	static_inventory += backhudl

	action_intent = new /obj/screen/act_intent/rogintent
	action_intent.hud = src
	action_intent.icon_state = "spiritintentbase"
	...
	using.screen_loc = "WEST-2,CENTER+2"
	using.hud = src
	...
	using.icon = ui_style
	using.screen_loc = "WEST-3,CENTER+2"
	using.hud = src
	static_inventory += using
