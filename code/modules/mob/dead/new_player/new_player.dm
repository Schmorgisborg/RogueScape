...
GLOBAL_LIST_INIT(craftrecipes_readme, world.file2list("strings/rt/crafting.txt"))
...
/*#ifdef MATURESERVER
		...
		var/timetojoin = 0 MINUTES
#ifdef ALLOWPLAY
		timetojoin = 0 MINUTES
#endif
#ifdef TESTSERVER
		timetojoin = 0 MINUTES
#endif
...
//					dat += "<div class='notice red'>The station is currently undergoing evacuation procedures.</div><br>"
	...
	var/list/omegalist = list(GLOB.good_positions, GLOB.bad_positions, GLOB.evil_positions)
