...
/datum/species/elf/snow
	name = "Elf"
	id = "elf"
	desc = "<b><font color='yellow'>I am an Elf</font></b><br>\
	<font color='teal'>Elves are among the longest lived of all the races of the world. They are noted \
	as being tall, graceful humanoids, with elongated ears. They follow the prophet Psydon, \
	who journeyed to Wyrld with them from their ancestral homeland.</font><br>\
	<font color='#008888'>Elves have a boon for perception, speed, and fortune.<br>\
	They are ailed by their frail frame, suffering in strength and constitution.</font>"
