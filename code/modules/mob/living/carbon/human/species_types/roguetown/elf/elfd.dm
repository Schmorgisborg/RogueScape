...
/datum/species/elf/dark
	...
	specstats = list("strength" = -1, "perception" = 0, "intelligence" = 2, "constitution" = -1, "endurance" = 1, "speed" = 2, "fortune" = -1)
	specstats_f = list("strength" = 0, "perception" = -1, "intelligence" = 1, "constitution" = -1, "endurance" = 2, "speed" = 1, "fortune" = -1)
