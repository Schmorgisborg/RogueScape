...
//				H.apply_status_effect(/datum/status_effect/debuff/fat)
		if(NUTRITION_LEVEL_FAT to INFINITY)
			if(H.hunger_check != 1)
				...
				H.remove_status_effect(list(/datum/status_effect/debuff/hungryt1,/datum/status_effect/debuff/hungryt2,/datum/status_effect/debuff/hungryt3))
				H.hunger_check = 1
		...
		if(NUTRITION_LEVEL_HUNGRY to NUTRITION_LEVEL_FED)
			if(H.hunger_check != 3)
				...
				H.remove_status_effect(list(/datum/status_effect/debuff/hungryt2,/datum/status_effect/debuff/hungryt3))
				H.hunger_check = 3
		if(NUTRITION_LEVEL_STARVING to NUTRITION_LEVEL_HUNGRY)
			if(H.hunger_check != 4)
				...
				H.remove_status_effect(list(/datum/status_effect/debuff/hungryt1,/datum/status_effect/debuff/hungryt3))
				H.hunger_check = 4
		if(0 to NUTRITION_LEVEL_STARVING)
			if(H.hunger_check != 5)
				...
				H.remove_status_effect(list(/datum/status_effect/debuff/hungryt1,/datum/status_effect/debuff/hungryt2))
				H.hunger_check = 5
			if(prob(3))
...
//			H.apply_status_effect(/datum/status_effect/debuff/waterlogged)
		if(HYDRATION_LEVEL_SMALLTHIRST to HYDRATION_LEVEL_FULL)
			if(H.thirst_check != 1)
				...
				H.remove_status_effect(/datum/status_effect/debuff/thirstyt1,/datum/status_effect/debuff/thirstyt2,/datum/status_effect/debuff/thirstyt3)
				H.thirst_check = 1
		if(HYDRATION_LEVEL_THIRSTY to HYDRATION_LEVEL_SMALLTHIRST)
			if(H.thirst_check != 2)
				...
				H.remove_status_effect(/datum/status_effect/debuff/thirstyt2,/datum/status_effect/debuff/thirstyt3)
				H.thirst_check = 2
		if(HYDRATION_LEVEL_DEHYDRATED to HYDRATION_LEVEL_THIRSTY)
			if(H.thirst_check != 3)
				...
				H.remove_status_effect(/datum/status_effect/debuff/thirstyt1,/datum/status_effect/debuff/thirstyt3)
				H.thirst_check = 3
		if(0 to HYDRATION_LEVEL_DEHYDRATED)
			if(H.thirst_check != 4)
				...
				H.remove_status_effect(/datum/status_effect/debuff/thirstyt1,/datum/status_effect/debuff/thirstyt2)
				H.thirst_check = 4
