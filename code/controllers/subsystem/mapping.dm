...
/datum/controller/subsystem/mapping/proc/loadWorld()
	...
	otherZ += load_map_config("_maps/map_files/roguetown/otherz/landofchaos.json")
	otherZ += load_map_config("_maps/rogueworld.json")
	#endif
	#ifdef ROGUEWORLD
	#endif
...
/client/proc/admin_away()
	...
	if(!GLOB.the_gateway)
		if(alert("There's no dungeon gateway. Continue?", "Uh oh", "Yes", "No") != "Yes")
			return
