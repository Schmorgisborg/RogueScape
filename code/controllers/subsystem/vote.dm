...
/datum/controller/subsystem/vote/proc/initiate_vote(vote_type, initiator_key)
	if(!mode)
		...
		var/text = "Restart vote started by [initiator]."
		if(mode == "custom")
			text += "\n[question]"
		log_vote(text)
