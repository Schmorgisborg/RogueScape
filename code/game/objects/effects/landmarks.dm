...
/obj/effect/landmark/start/adventurerlate
	name = "Adventurerlate"
	icon_state = "arrow"
	jobspawn_override = list("Adventurer", "Pilgrim")
	delete_after_roundstart = FALSE
/obj/effect/landmark/start/adventurer
	name = "Adventurer"
	icon_state = "arrow"

/obj/effect/landmark/start/startKingdom
	name = "Kingdom Start"
	icon_state = "arrow"
...
/obj/effect/landmark/start/lateNight
	name = "Late Night"
	icon_state = "arrow"
	jobspawn_override = list("Nightman","Grabber", "Younker")
	delete_after_roundstart = FALSE
/obj/effect/landmark/start/nightman
	name = "Nightmaster"
	icon_state = "arrow"
	jobspawn_override = list("Nightman")
/obj/effect/landmark/start/grabber
	name = "Grabber"
	icon_state = "arrow"
	jobspawn_override = list("Grabber")
/obj/effect/landmark/start/butler
	name = "Butler"
	icon_state = "arrow"
	jobspawn_override = list("Younker")

/obj/effect/landmark/start/skeleton
	name = "Skeleton"
	icon_state = "arrow"
	jobspawn_override = list("Skeleton")
	delete_after_roundstart = FALSE
	used = TRUE
